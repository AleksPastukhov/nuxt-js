...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-1c65beaa.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-40729390.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/_id_-b3765036.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-a9e0c91f.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-d6cb152b.mjs').then((m) => m.default || m),
  products: () => import('./_nuxt/products-8519f96a.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-5210b81f.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRoute as a, useNuxtApp as b, createError as c, useRouter as d, entry$1 as default, navigateTo as n, useHead as u };
